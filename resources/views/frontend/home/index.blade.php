                                             ...
                                             <div class="grid-arr">
                                                  <div class="grid-arrival">
                                                       <figure>
                                                            <a href="single.html">
                                                                 <div class="grid-img">
                                                                      <img src="{{asset('/product/'.$hot_product->image)}}" class="img-responsive" alt="">
                                                                 </div>
                                                                 <div class="grid-img">
                                                                      <img src="{{asset('/product/'.$hot_product->image)}}" class="img-responsive" alt="">
                                                                 </div>
                                                  ...
                                                  <div class="women">
                                                       <h6><a href="single.html">{{$hot_product->name}}</a></h6>
                                                       <span class="size">{{$hot_product->size->name}}</span>
                                                       <p><em class="item_price">${{$hot_product->price}}</em></p>
                                                       <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                  </div>
                                             </div>
                                        </div>
