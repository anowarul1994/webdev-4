     ...
     <div class="container">
          <div class="footer-grids">
               ...
               <div class="col-md-3 footer-grid foot">
                    <h4>Contacts</h4>
                    <ul>
                         <li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i><a href="#">E
                                   Comertown Rd, Westby, USA</a></li>
                         <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><a href="#">1
                                   599-033-5036</a></li>
                         <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
                                   href="mailto:example@mail.com"> anowarul2021@gmail.com</a></li>
...
<div class="copy-section">
     <div class="container">
          <div class="copy-left">
               <p>&copy; 2022 New Shop . All rights reserved | Design by <a href=" {{url('/')}} ">M.Anowarul Islam</a>
               </p>
          </div>
               ...
               <div class="modal-body">
                    <div class="news-gr">
                         ...
                         <div class="col-md-7 new-grid">
                              ...
                              <span>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
